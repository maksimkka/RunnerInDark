...
namespace Code.Hero
{
    public class HeroInit : IEcsInitSystem
    {
        ...
        public void Init(IEcsSystems systems)
        {
            ...
            ref var groundChecker = ref _groundChecker.Value.Add(entity);
            groundChecker.Detector =
                _heroSettings.Value.GroundCheckerMarker.GetComponent<UnityPhysicsCollisionDetector>();
            groundChecker.Detector.Init(entity, systems.GetWorld());

            ref var waterCheckerMarker = ref _waterCheckerMarker.Value.Add(entity);
            waterCheckerMarker.Detector =
                _heroSettings.Value.WaterCheckerMarker.GetComponent<UnityPhysicsCollisionDetector>();
